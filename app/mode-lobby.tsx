...
export function ModeLobby({ game, teams, isHost, gameMode, roundsPerPlayer, durationSeconds, roundLimit, setTeams, setGameMode, setRoundsPerPlayer, setDurationSeconds, setRoundLimit, assign, start, busy }: Props) {
